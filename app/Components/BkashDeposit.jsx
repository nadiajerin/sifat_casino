...
export const BkashDeposit = ({img, text}) => {
                            ...
                            <div className="p-4 space-y-4">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <span className="font-bold text-[#2c3e50] text-[12px]">Bkash wallet number</span>
                                ...
                                <div className="flex justify-between items-center gap-4">
                                    <label className="text-[#2c3e50] text-[14px] leading-tight flex-1">
                                        আপনার বিকাশ ওয়ালেট নাম্বার ( আমরা শুধুমাত্র ক্যাশ গ্রহণ করে থাকি):
                                    </label>
